...
#
#  • Default CSV  : tot_graphrag_d1.csv          <── change here
#  • PNG output   : 00_confusion_matrix_tot.png  <── change here
#
# You can still override the CSV on the command-line:
#   Rscript 00_confusion.R  tot_graphrag_d7.csv
# ─────────────────────────────────────────────────────────────

# ---------- helper: minimal auto-installer ------------------
...
csv_file <- if (length(args) >= 1) args[1] else "tot_graphrag_d2.csv"
...
png_out <- "02_02_confusion_matrix_tot.png"
