...
#
#  • Default CSV  : tot_baseline_null_d1.csv      ← edit if you like
#  • PNG output   : 00_confusion_matrix_baseline_null.png
#
# You can override the CSV via the command-line, e.g.:
#   Rscript 00_confusion.R  another_file.csv
# ─────────────────────────────────────────────────────────────
...
csv_file <- if (length(args) >= 1) args[1] else "tot_baseline_null_d1.csv"
...
png_out <- "00_confusion_matrix_baseline_null.png"
